/**
 * background.js
 * Génère et anime les bulles parallax en arrière-plan.
 *
 * Logique :
 * - 3 groupes de profondeur : loin (grandes, lentes) → près (petites, rapides)
 * - Le scroll est capturé sur #scroller
...
// Met à jour le point actif dans la nav latérale
